...
# <img src='images/askmusic_logo.jpg' style='width: 10%'></img> Prostate Cancer Treatment Options
...
conditionalPanel('input.tx_start>0 && (input.tx_t != "Do not know" && input.tx_n != "Do not know")',
                 wellPanel(
                   ...
                   h5("According to the National Comprehensive Cancer Network, appropriate treatment options include: "),
                   h5(htmlOutput('rec')),
...
favorable_risk = reactive({
  ...
  # 
  # if (gg_val == 'GG2') {
  #   if ((input$tx_poscores <= 3) & more_than_50_cores == FALSE) {
  #     return(TRUE)
  #   }
  # }
  # return(FALSE)

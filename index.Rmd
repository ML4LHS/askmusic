---
title: 'Jake Huang Sample askMUSIC Website'
author: 'Jake Huang'
date: '6/29/2020'
...
# h2o::h2o.init(startH2O =TRUE)
```

```{r context='server', include=FALSE}
# h2o::h2o.init(startH2O=FALSE)

# tx_model = h2o::h2o.loadModel('tx_model_nomets_recent2yrs')
...
wellPanel(style = "background: #FFF;",
          ...
          flowLayout(sliderInput('tx_poscores','Biopsy cores with cancer',
                        min=1,
                        max=14,
                        step=1,
                        value=3,
            ...
            sliderInput('tx_totcores','Total cores taken',
                        ...
                        value=12,
                        dragRange=FALSE),
          selectInput('tx_t', 'Enter your T of TNM', choices=c('Do not know', 'T1', 'T2a', 'T2b', 'T2c', 'T3a', 'T3b', 'T4'), selected='Do not know'),
          selectInput('tx_n', 'Enter your N of TNM', choices=c('Do not know', 'N0', 'N1'), selected='Do not know'),
          #selectInput('tx_m', 'Enter your M of TNM', choices=c('Do not know', 'N0', 'N1'), selected='Do not know'),
          selectInput('tx_corestats', 'Do you have any cores with more than 50% cancer?', choices=c('Do not know', 'Yes', 'No'), selected='Do not know')),
          br(),
